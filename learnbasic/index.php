...
include 'header/H_header.php';
include 'menu/M_menu.php';

?>

<!-- <div class="slide-one-item home-slider owl-carousel">
      
      <div class="site-blocks-cover inner-page overlay" style="background-image: url(../code/images/hero_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
      ...
      <div class="site-blocks-cover inner-page overlay" style="background-image: url(../code/images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
  ...
  <div class="site-half">
    <div class="img-bg-1" style="background-image: url('../code/images/img_4.jpg');" data-aos="fade"></div>
    <div class="container">
  ...
  <div class="site-half block">
    <div class="img-bg-1 right" style="background-image: url('../code/images/img_5.jpg');" data-aos="fade"></div>
    <div class="container">
      <div class="row no-gutters align-items-stretch">
  ...
  <div class="site-section ">
          ...
          <div class="col-md-12 block-13 nav-direction-white">
            <div class="nonloop-block-13 owl-carousel">
              <div class="media-image">
                <img src="../code/images/img_1.jpg" alt="Image" class="img-fluid">
              ...
              <div class="media-image">
                <img src="../code/images/img_2.jpg" alt="Image" class="img-fluid">
                <div class="media-image-body">
              ...
              <div class="media-image">
                <img src="../code/images/img_3.jpg" alt="Image" class="img-fluid">
                <div class="media-image-body">
              ...
              <div class="media-image">
                <img src="../code/images/img_4.jpg" alt="Image" class="img-fluid">
                <div class="media-image-body">
              ...
              <div class="media-image">
                <img src="../code/images/img_5.jpg" alt="Image" class="img-fluid">
                <div class="media-image-body">
    ...
    <div class="site-section section-counter">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
            <p class="mb-5"><img src="../code/images/img_1.jpg" alt="Image" class="img-fluid"></p>
          </div>
        ...
        <div class="nonloop-block-14 owl-carousel">
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="../code/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle w-25 mx-auto">
              </div>
              <div>
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="../code/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle w-25 mx-auto">
              </div>
              <div>
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="../code/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle w-25 mx-auto">
              </div>
              <div>
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="../code/images/person_4.jpg" alt="Image" class="img-fluid rounded-circle w-25 mx-auto">
              </div>
              <div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="100">
            <div class="media-image">
              <a href="single.html"><img src="../code/images/img_1.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
          ...
          <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="200">
            <div class="media-image">
              <a href="single.html"><img src="../code/images/img_2.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">Where Do You Learn HTML & CSS in 2019?</a></h2>
                <span class="d-block mb-3">By James &mdash; Jan. 20, 2019</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga, voluptate.</p>
          ...
          <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up" data-aos-delay="300">
            <div class="media-image">
              <a href="single.html"><img src="../code/images/img_3.jpg" alt="Image" class="img-fluid"></a>
              <div class="media-image-body">
                <h2 class="font-secondary text-uppercase"><a href="single.html">Where Do You Learn HTML & CSS in 2019?</a></h2>
                <span class="d-block mb-3">By James &mdash; Jan. 20, 2019</span>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga, voluptate.</p>
